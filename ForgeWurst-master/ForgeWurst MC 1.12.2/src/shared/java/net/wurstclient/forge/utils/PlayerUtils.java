...
public class PlayerUtils
{
	...
	public static BlockPos getHoles0() {
		int radius = 20;
	...
	public static BlockPos getHoles1() {
		int radius = 20;
		for (int x = (int) -radius; x <= radius; x++) {
			for (int z = (int) -radius; z <= radius; z++) {
				for (int y = (int) -radius; y <= radius; y++) {
	...
	public static BlockPos getHoles2() {
		int radius = 20;
		for (int x = (int) -radius; x <= radius; x++) {
			for (int z = (int) -radius; z <= radius; z++) {
				for (int y = (int) -radius; y <= radius; y++) {
	...
	public static BlockPos getHoles3() {
		int radius = 20;
		for (int x = (int) -radius; x <= radius; x++) {
			for (int z = (int) -radius; z <= radius; z++) {
				for (int y = (int) -radius; y <= radius; y++) {
